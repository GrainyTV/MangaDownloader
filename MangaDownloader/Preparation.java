...
class Preparation implements Runnable
{
	...
	public void ExtractNecessaryPageData()
	{
		try
		{		
			Document document = Jsoup.connect(InsertChapterIntoURL(url, chapter)).timeout(60000).userAgent("Chrome").get();
    ...
    public String InsertChapterIntoURL(String url, int chapter)
    {
