...
class Link extends StatefulWidget 
{
	...
	Link({ required this.close, required this.next });
	...
	@override
	Link_State createState() => Link_State();
}

class Link_State extends State<Link> 
{
	@override
            ...
            [
                ...
                (
                	...
                	(
                		...
                		child: Text('Location', style: TextStyle(fontSize: 30, fontFamily: 'Tisa', fontWeight: FontWeight.bold))
                	)
                ),
